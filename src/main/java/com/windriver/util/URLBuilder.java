...
public class URLBuilder {
    ...
    public URLBuilder addHubHeadURL() {
        folders.append(EnvironmentProperties.HUB_URL_CONNECTION_TYPE.readString()).append("://")
                .append(EnvironmentProperties.HUB_URL_HOST.readString()).append(":")
                .append(EnvironmentProperties.HUB_URL_PORT.readString());
        return this;
    }
}
